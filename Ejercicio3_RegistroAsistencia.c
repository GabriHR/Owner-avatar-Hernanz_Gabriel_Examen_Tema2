...
int main() {
    ...
    registrarAsistencia(&estudiante1, "2023-01-01", "Programacion", "asistio");
    registrarAsistencia(&estudiante1, "2023-01-02", "Lengua", "falta");
    registrarAsistencia(&estudiante1, "2023-01-03", "Historia", "tardanza");
